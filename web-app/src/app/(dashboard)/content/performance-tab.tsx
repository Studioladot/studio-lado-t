...
export function PerformanceTab({
  ...
  if (!instagramConnected) {
    return (
      <div className="rounded-card border border-dashed border-border bg-surface-2/40 px-6 py-12 text-center">
        <p className="text-sm font-semibold text-text">Todavía no conectaste Instagram</p>
        <p className="mx-auto mt-1 max-w-[380px] text-xs text-text-2">
          Conectá tu cuenta de Instagram Business desde Ajustes → Integraciones para ver reproducciones, alcance y seguidores acá.
        </p>
        <Link
  ...
  if (accountInsights.length === 0 && mediaInsights.length === 0) {
    return (
      <div className="rounded-card border border-dashed border-border bg-surface-2/40 px-6 py-12 text-center">
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {/* Ganadores (Épica Omnicanal, 2026-08-04) — picos de crecimiento
          ...
          hoy solo hay datos de Instagram, pero funciona igual apenas la
          Fase 2 de TikTok empiece a sincronizar métricas. */}
