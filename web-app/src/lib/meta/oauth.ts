...
// pages_read_engagement se sumaron para la integración de Instagram
// (2026-07-30) — mismo login de Facebook, la cuenta de Instagram Business/
// Creator se resuelve vía la Página vinculada (getInstagramBusinessAccounts,
// src/lib/instagram/accounts.ts). Es el mínimo scope real: sin
// instagram_content_publish no se puede autopublicar, sin
// instagram_manage_insights no hay métricas, sin pages_read_engagement no
// se puede leer instagram_business_account en /me/accounts. Conexiones
// existentes van a necesitar reconectar otra vez.
export const META_OAUTH_SCOPE =
  'ads_read,ads_management,business_management,pages_show_list,pages_read_engagement,instagram_basic,instagram_content_publish,instagram_manage_insights'
